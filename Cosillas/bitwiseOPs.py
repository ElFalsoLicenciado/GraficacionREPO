...
# Operacion para comparar que pixeles comparten
result = cv2.bitwise_and(img1, img2) 

# Operacion para unir los pixeles de ambos
# result = cv2.bitwise_or(img1, img2)

# Operacion para usar los pixeles que img 1 tiene y img 2 y vice versa
# result = cv2.bitwise_xor(img1, img2)

# Operacion para negar los pixeles
# result = cv2.bitwise_not(img1)

# Mostrar las imágenes
cv2.imshow("img1", img1) 
cv2.imshow("img2", img2)
cv2.imshow("Operador", result)
cv2.waitKey(0)
