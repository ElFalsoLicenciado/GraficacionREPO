...
img2 = np.zeros((img.shape[:2]), dtype=np.uint8) # img.shape[:2] da las dimensiones
...
# Para fucionar se debe tener que cada uno tenga un solo canal
c2 = cv.merge([g,b,r])
