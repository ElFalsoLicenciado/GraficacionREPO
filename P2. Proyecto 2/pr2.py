...
WINDOW_WIDTH = 640
WINDOW_HEIGHT = 480
WINDOW_TITLE = "Filtro de Snapchat @TM"
...
def draw_sphere(x, y, z, radius, color=(1, 1, 1)):
    ...
    radius: float
        Radio del círculo, esto será muy importante, ya que con este parámetro se controlará el tamaño de este, por ende al haber un cambio en referencia al tamaño del rostro este debe cambiar de acorde.

    color: tuple, default: (1,1,1)
        Este parámetro permite 3 valores de 0 a 1 (normalizados) que cada uno representa un color (RGB).
...
def draw_line(p1, p2, color=(1, 1, 1), width=2.0):
    ...
    p2 : tuple
        Último punto de la recta.
    color : tuple, default: (1,1,1)
        Este parámetro permite 3 valores de 0 a 1 (normalizados) que cada uno representa un color (RGB).
    width : float, default: 2.0
        Parámetro de la anchura/grosor de la línea.
    """
...
def norm_landmark(p):
    """Retorna un arreglo con las coordenadas 3D.
    Parameters
    ------
    p : landmark
        Es el landmark el cual se usarán sus atributos de coordenadas x y z.
    """
